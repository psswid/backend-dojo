...
return [
    ...
    'request_timeout' => env('LLM_TIMEOUT', 120), // The timeout for requests in seconds.
    'providers' => [
        'openai' => [
            // Pointed at the local Olympus LiteLLM proxy (OpenAI-compatible).
            'url' => env('LLM_BASE_URL', 'https://api.openai.com/v1'),
